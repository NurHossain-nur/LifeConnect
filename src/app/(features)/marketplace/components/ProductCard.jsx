export default function ProductCard({ product, addToCart }) {
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition border border-gray-100 flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="mt-4 flex items-center gap-2">
          ...
          />
          <button
            onClick={() => addToCart(product, Number(document.getElementById(`qty-${product._id}`).value))}
